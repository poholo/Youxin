...
#import "UIUtils.h"
@interface MoreThan24hViewController ()<MJRefreshBaseViewDelegate>
{
...
@implementation MoreThan24hViewController
...
- (void)viewDidLoad
{
    ...
    _tbMoreThan24h = [[UITableView alloc] initWithFrame:CGRectMake(0, 44, 320, self.view.bounds.size.height - 44 - 49)];
    _tbMoreThan24h.delegate = self;
    _tbMoreThan24h.dataSource = self;
    _tbMoreThan24h.allowsSelection = NO;
    _tbMoreThan24h.separatorStyle =UITableViewCellSeparatorStyleNone;
    _tbMoreThan24h.backgroundColor = [UIColor clearColor];
    
    [self.view addSubview:_tbMoreThan24h];
    
    // 下拉刷新
    _header = [[MJRefreshHeaderView alloc] init];
    _header.delegate = self;
    _header.scrollView = _tbMoreThan24h;
    
    // 上拉加载更多
    _footer = [[MJRefreshFooterView alloc] init];
    _footer.delegate = self;
    _footer.scrollView = _tbMoreThan24h;
...
-(void)reloadTableCellinfo{
    ...
    [_tbMoreThan24h deleteRowsAtIndexPaths:[NSArray arrayWithObject:self.currentInfoCell.indexpath] withRowAnimation:UITableViewRowAnimationTop];
