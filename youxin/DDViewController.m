...
- (void)viewDidLoad
{
	...
	// Do any additional setup after loading the view.
    DDAllViewController *allvc = [[DDAllViewController alloc] init];
    DDWeekViewController *wvc = [[DDWeekViewController alloc] init];
    DDMonthViewController *mvc = [[DDMonthViewController alloc] init];
