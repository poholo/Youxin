...
#import "DDWeekViewController.h"
#import "UIUtils.h"

#import "AlertUtils.h"
#import "DateUtils.h"
@interface DDWeekViewController ()

@end

@implementation DDWeekViewController
...
-(void)refreshFrameData{
    ...
    self.fgvNewAdd.frame = CGRectMake(0, _srcvw.bounds.size.height - line2Height-3,
                                      xsplit*[_currentShowLine2Arr count],
                                      line2Height);
    self.fgvCancel.dataPoints = self.currentShowLine3Arr;
    CGRect rect = self.fgvNewAdd.frame;
    NSLog(@"frame-------%f,%f,%f,%f,",rect.origin.x,rect.origin.y,rect.size.width,rect.size.height);
    self.fgvCancel.frame = CGRectMake(0, _srcvw.bounds.size.height - line3Height-3,
