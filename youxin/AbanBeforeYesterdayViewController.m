//
//  AbanBeforeYesterdayViewController.m
//  youxin
//
...
#import "AbanBeforeYesterdayViewController.h"
...
@interface AbanBeforeYesterdayViewController ()<MJRefreshBaseViewDelegate>
{
...
@implementation AbanBeforeYesterdayViewController
...
- (void)viewDidLoad
{
    ...
    _tbBeforeYesterday = [[UITableView alloc] initWithFrame:CGRectMake(0, 44, 320, self.view.bounds.size.height - 44 - 49)];
