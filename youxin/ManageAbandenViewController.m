...
#import "MAYesterdayViewController.h"
...
@interface ManageAbandenViewController (){
    //    NSArray *normalArr;
...
@implementation ManageAbandenViewController
...
- (void)viewDidLoad
{
	...
	// Do any additional setup after loading the view.
    MATodayViewController *todayvc = [[MATodayViewController alloc] init];
    MAYesterdayViewController *yesterdayvc = [[MAYesterdayViewController alloc] init];
    MABeforeYesterdayViewController *beforeYesterdayvc = [[MABeforeYesterdayViewController alloc] init];
