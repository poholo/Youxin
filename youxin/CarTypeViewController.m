...
- (void)viewDidLoad
{
	...
	// Do any additional setup after loading the view.
    UIViewController *vc = [[CarTypeAllxibViewController alloc] initWithNibName:@"CarTypeAllxibViewController" bundle:nil];
//    CarTypeAllViewController *allvc = [[CarTypeAllViewController alloc] init];
    CarTypeWeekViewController *weekvc = [[CarTypeWeekViewController alloc] init];
    CarTypeMonthViewController *monthvc = [[CarTypeMonthViewController alloc] init];
    
    
    
    self.viewControllers = [NSArray arrayWithObjects:vc,weekvc,monthvc, nil];
