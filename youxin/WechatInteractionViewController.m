//
//  WechatInteractionViewController.m
//  youxin
//
...
@interface WechatInteractionViewController (){
    //    NSArray *normalArr;
...
@implementation WechatInteractionViewController
...
- (void)viewDidLoad
{
	...
	// Do any additional setup after loading the view.
    WIAllViewController *allvc = [[WIAllViewController alloc] init];
    WIWeekViewController *wvc = [[WIWeekViewController alloc] init];
    WIMonthViewController *mvc = [[WIMonthViewController alloc] init];
