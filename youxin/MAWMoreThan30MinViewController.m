//
//  MAWMoreThan30MinViewController.m
//  youxin
//
...
#import "MAWMoreThan30MinViewController.h"
...
#import "InfoModel.h"
#import "UIUtils.h"
@interface MAWMoreThan30MinViewController ()<MJRefreshBaseViewDelegate>
{
...
@implementation MAWMoreThan30MinViewController
...
- (void)viewDidLoad
{
    ...
    _tbMoreThan30Min = [[UITableView alloc] initWithFrame:CGRectMake(0, 44, 320, self.view.bounds.size.height - 44 - 49)];
    _tbMoreThan30Min.delegate = self;
    _tbMoreThan30Min.dataSource = self;
    
    _tbMoreThan30Min.allowsSelection = NO;
    _tbMoreThan30Min.separatorStyle = UITableViewCellSeparatorStyleNone;
    
    _tbMoreThan30Min.backgroundColor = [UIColor clearColor];
    
    [self.view addSubview:_tbMoreThan30Min];
    
    
    // 下拉刷新
    _header = [[MJRefreshHeaderView alloc] init];
    _header.delegate = self;
    _header.scrollView = _tbMoreThan30Min;
    
    // 上拉加载更多
    _footer = [[MJRefreshFooterView alloc] init];
    _footer.delegate = self;
    _footer.scrollView = _tbMoreThan30Min;
...
-(UITableViewCell*)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if(nil == cell){
        cell = [[ManInfoCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"cell" btnno:2 taget:self sel:@selector(cellBtnClick:) sel2:@selector(tgrclick:)];
    }
...
-(void)reloadTableCellinfo{
    ...
    [_tbMoreThan30Min deleteRowsAtIndexPaths:[NSArray arrayWithObject:self.currentInfoCell.indexpath] withRowAnimation:UITableViewRowAnimationTop];
