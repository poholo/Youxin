//
//  ManageWaitInfoViewController.m
//  youxin
//
...
@implementation ManageWaitInfoViewController
...
- (void)viewDidLoad
{
    ...
    MAWAllViewController *allvc = [[MAWAllViewController alloc] init];
    MAWMoreThar15MinViewController *moreThan15Min = [[MAWMoreThar15MinViewController alloc] init];
    MAWMoreThan30MinViewController *moreThan30Min = [[MAWMoreThan30MinViewController alloc] init];
    
    
    
    self.viewControllers = [NSArray arrayWithObjects:allvc,moreThan15Min,moreThan30Min, nil];
    ...
    normalTitleArr = [[NSArray alloc] initWithObjects:@"全部",@"超15分钟",@"超30分钟", nil];
    selectBg = @"baritem";
    unselectbg = @"";
