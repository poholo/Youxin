...
- (void)viewDidLoad
{
	...
	// Do any additional setup after loading the view.
    TodayViewController *wvc = [[TodayViewController alloc] init];
    YesterdayViewController *cvc = [[YesterdayViewController alloc] init];
    BeforeYesterdayViewController *avc = [[BeforeYesterdayViewController alloc] init];
