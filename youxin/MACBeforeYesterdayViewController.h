//
//  MACBeforeYesterdayViewController.h
//  youxin
//
...
@interface MACBeforeYesterdayViewController : UIViewController<UITableViewDataSource,UITableViewDelegate,UIActionSheetDelegate,UIAlertViewDelegate,HttpdownloadDelegate>
