...
- (void)viewDidLoad
{
	...
	// Do any additional setup after loading the view.
    TZAllViewController *allvc = [[TZAllViewController alloc] init];
    TZWeekViewController *wvc = [[TZWeekViewController alloc] init];
    TZMonthViewController *mvc = [[TZMonthViewController alloc] init];
