...
@interface TZAllViewController : UIViewController <XYPieChartDataSource,XYPieChartDelegate,HttpdownloadDelegate,UITableViewDataSource,UITableViewDelegate>
