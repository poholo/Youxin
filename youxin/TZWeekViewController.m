...
#import "TZWeekViewController.h"
#import "CarCell.h"
#import <QuartzCore/QuartzCore.h>
#import "DateUtils.h"
#import "UIUtils.h"

@interface TZWeekViewController ()

@end

@implementation TZWeekViewController
...
- (void)viewDidLoad
{
    ...
    //title
    _lbTitle = [UIUtils createDataTitleLabelWithFrame:CGRectMake(0, 0, 320, 40) text:[NSString stringWithFormat:@"%@ 至 %@",[self converDateToString:_startDate],[self converDateToString:_endDate]]];
