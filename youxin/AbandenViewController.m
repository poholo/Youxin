...
@implementation AbandenViewController
...
- (void)viewDidLoad
{
	...
	// Do any additional setup after loading the view.
    AbanTodayViewController *wvc = [[AbanTodayViewController alloc] init];
    AbanYesterdayViewController *cvc = [[AbanYesterdayViewController alloc] init];
    AbanBeforeYesterdayViewController *avc = [[AbanBeforeYesterdayViewController alloc] init];
...
-(void)switchTabbar:(NSInteger)tag{
    ...
    NSLog(@"%@----%@",arr ,tmarr);    NSArray * picnmArr =nil;
