...
#import "MATodayViewController.h"
...
@interface MATodayViewController ()<MJRefreshBaseViewDelegate>
{
...
@implementation MATodayViewController
...
- (void)viewDidLoad
{
    ...
    _tbToday = [[UITableView alloc] initWithFrame:CGRectMake(0, 44, self.view.bounds.size.width, self.view.bounds.size.height - 44 - 49) style:UITableViewStylePlain];
...
-(UITableViewCell*)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if(nil == cell){
        cell = [[ManInfoCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"cell" btnno:0 taget:self sel:@selector(cellBtnClick:) sel2:@selector(tarclick:)];
    }
...
-(void)reloadTableCellinfo{
    ...
    [_tbToday deleteRowsAtIndexPaths:[NSArray arrayWithObject:self.currentInfoCell.indexpath] withRowAnimation:UITableViewRowAnimationTop];
