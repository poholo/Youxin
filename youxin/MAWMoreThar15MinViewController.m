//
//  MAWMoreThar15MinViewController.m
//  youxin
//
...
#import "MAWMoreThar15MinViewController.h"
...
@interface MAWMoreThar15MinViewController ()<MJRefreshBaseViewDelegate>
{
...
@implementation MAWMoreThar15MinViewController
...
- (void)viewDidLoad
{
    ...
    _tbMoreThan15Min = [[UITableView alloc] initWithFrame:CGRectMake(0, 44, 320, self.view.bounds.size.height - 44 - 49)];
    _tbMoreThan15Min.delegate = self;
    _tbMoreThan15Min.dataSource = self;
    
    _tbMoreThan15Min.allowsSelection = NO;
    _tbMoreThan15Min.separatorStyle = UITableViewCellSeparatorStyleNone;
    
    _tbMoreThan15Min.backgroundColor = [UIColor clearColor];
    
    [self.view addSubview:_tbMoreThan15Min];
    
    
    // 下拉刷新
    _header = [[MJRefreshHeaderView alloc] init];
    _header.delegate = self;
    _header.scrollView = _tbMoreThan15Min;
    
    // 上拉加载更多
    _footer = [[MJRefreshFooterView alloc] init];
    _footer.delegate = self;
    _footer.scrollView = _tbMoreThan15Min;
...
-(void)reloadTableCellinfo{
    ...
    [_tbMoreThan15Min deleteRowsAtIndexPaths:[NSArray arrayWithObject:self.currentInfoCell.indexpath] withRowAnimation:UITableViewRowAnimationTop];
