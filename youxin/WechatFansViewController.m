...
#import "WFMonthViewController.h"


@interface WechatFansViewController (){
    //    NSArray *normalArr;
...
@implementation WechatFansViewController
...
- (void)viewDidLoad
{
	...
	// Do any additional setup after loading the view.
    WFAllViewController *allvc = [[WFAllViewController alloc] init];
    WFWeekViewController *wvc = [[WFWeekViewController alloc] init];
    WFMonthViewController *mvc = [[WFMonthViewController alloc] init];

    
    
    
    self.viewControllers = [NSArray arrayWithObjects:allvc,wvc,mvc, nil];
