...
@interface MAWAllViewController : UIViewController<UITableViewDataSource,UITableViewDelegate,UIActionSheetDelegate,UIAlertViewDelegate,HttpdownloadDelegate>
@property (nonatomic,retain) UITableView *tbAll;
