...
@interface CarTypeMonthViewController : UIViewController<XYPieChartDataSource,XYPieChartDelegate,HttpdownloadDelegate,UITableViewDataSource,UITableViewDelegate>
...
@property (nonatomic,retain) NSArray *daySumOfMonthByRunYear;
@property (nonatomic,retain) NSArray *daySumOfMonthByUnRunYear;
